...
* [http://localhost/api/test](http://localhost/api/users) - Эндпойнт возвращает спискок пользователь
* [http://localhost/api/test](http://localhost/api/user/<id>) - Эндпойнт возвращает одного пользователя (+генерит событие рассылки в центрифугу)